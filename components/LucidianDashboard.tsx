...
export default function LucidianDashboard() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const reply = data.reply || "Lucidian is thinking...";

      setMessages((prev) => [...prev, { role: "lucidian", content: reply }]);
    } catch (err) {
      console.error("Error:", err);
      setMessages((prev) => [...prev, { role: "lucidian", content: "⚠️ Error sending message." }]);
    }
  };
